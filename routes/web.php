...
Route::post( '/update-user/{id}' , [DashbordController::class , 'updateUser'])->middleware('guard');
Route::post( '/update-user-add/{id}' , [DashbordController::class , 'addUpdateUser'])->middleware('guard');
Route::post( '/delete-user/{id}', [DashbordController::class , 'deleteUser'])->middleware('guard');
